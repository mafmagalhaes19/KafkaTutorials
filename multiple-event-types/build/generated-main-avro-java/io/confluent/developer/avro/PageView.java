...
public class PageView extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6652820606086400073L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PageView\",\"namespace\":\"io.confluent.developer.avro\",\"fields\":[{\"name\":\"url\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"is_special\",\"type\":\"boolean\"},{\"name\":\"customer_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
  ...
  @Deprecated public boolean is_special;
   ...
   * @param is_special The new value for is_special
   * @param customer_id The new value for customer_id
   */
  public PageView(java.lang.String url, java.lang.Boolean is_special, java.lang.String customer_id) {
    this.url = url;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: is_special = (java.lang.Boolean)value$; break;
   ...
   * @return The value of the 'is_special' field.
   */
   ...
   */
  public static io.confluent.developer.avro.PageView.Builder newBuilder() {
    return new io.confluent.developer.avro.PageView.Builder();
  }
   ...
   * @return A new PageView RecordBuilder
   */
  public static io.confluent.developer.avro.PageView.Builder newBuilder(io.confluent.developer.avro.PageView.Builder other) {
    if (other == null) {
      return new io.confluent.developer.avro.PageView.Builder();
    } else {
      return new io.confluent.developer.avro.PageView.Builder(other);
    }
  }
   ...
   * @return A new PageView RecordBuilder
   */
  public static io.confluent.developer.avro.PageView.Builder newBuilder(io.confluent.developer.avro.PageView other) {
    if (other == null) {
      return new io.confluent.developer.avro.PageView.Builder();
    } else {
      return new io.confluent.developer.avro.PageView.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PageView>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.confluent.developer.avro.PageView.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.url)) {
        this.url = data().deepCopy(fields()[0].schema(), other.url);
        fieldSetFlags()[0] = other.fieldSetFlags()[0];
      }
      if (isValidValue(fields()[1], other.is_special)) {
        this.is_special = data().deepCopy(fields()[1].schema(), other.is_special);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.confluent.developer.avro.PageView other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.url)) {
        this.url = data().deepCopy(fields()[0].schema(), other.url);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.PageView.Builder setUrl(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.PageView.Builder clearUrl() {
      url = null;
    ...
    /**
      * Sets the value of the 'is_special' field.
      * @param value The value of 'is_special'.
      * @return This builder.
      */
    public io.confluent.developer.avro.PageView.Builder setIsSpecial(boolean value) {
    ...
    /**
      * Checks whether the 'is_special' field has been set.
      * @return True if the 'is_special' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'is_special' field.
      * @return This builder.
      */
    public io.confluent.developer.avro.PageView.Builder clearIsSpecial() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.PageView.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.PageView.Builder clearCustomerId() {
      customer_id = null;
    ...
    public PageView build() {
      try {
        ...
        record.is_special = fieldSetFlags()[1] ? this.is_special : (java.lang.Boolean) defaultValue(fields()[1]);
    ...
    throws java.io.IOException
  {
    ...
    out.writeBoolean(this.is_special);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.is_special = in.readBoolean();
